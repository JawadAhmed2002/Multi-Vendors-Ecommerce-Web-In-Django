"""
Django settings for MultiVendorsEcommerce project.
...
SECRET_KEY = 'aa&v(6l=ddkwscpnwb5fw$uv+uky=_(6cy)_+_kdty8j5ntmio'
...
ROOT_URLCONF = 'MultiVendorsEcommerce.urls'
...
WSGI_APPLICATION = 'MultiVendorsEcommerce.wsgi.application'
